...
function NCD(){
var d=GO("showdetail");
parent.ECD((d.charAt(0)=="_")?null:d,(d=="_pq")?true:((d=="_pl")?false:null),(d=="_m1")?true:((d=="_m0")?false:null));
}
function NSP(i){
...
var p=parent.Efa[j];
var l=p.l||p.q;
jn[jn.length]={i:j,l:l?l.toLowerCase():"zzz",p:p.p?p.p.toLowerCase():"zzz",n:p.n};
}
jn.sort(NSN);
var v=GE("personjump");
v.options.length=0;
for(j=0;j<jn.length;j++){
v.options[v.options.length]=new Option(EH(jn[j].n),jn[j].i);
}
