...
var Sen=[{p:"personalname",l:"familyname",q:"familybirth"},{e:"email",w:"website",B:"blog",P:"photosite",t:"hometel",k:"worktel",u:"mobile",S:"skype",a:"address",C:"othercontact"},{v:"birthplace",y:"deathplace",j:"profession",E:"employer",I:"interests",A:"activities",o:"bionotes"}];
var Sv1={e:"Email",w:"Website",B:"Blog",P:"Photo site",t:"Home tel",k:"Work tel",u:"Mobile",S:"Skype",a:"Address",C:"Other"};
var Sv2={v:"Birth place",y:"Death place",j:"Profession",E:"Company",I:"Interests",A:"Activities",o:"Bio notes"};
...
if(uf){
SV("urlmode",Sur[uf]);
SV("showurl","Show "+(md?"my":(p.h+"'s"))+" "+Sv1[uf].toLowerCase());
}
...
if(gpi=="m"){
var t={m:"Wedding date",w:"Location",z:(cp?"":"End date")};
}else{
if(gpi=="e"){
var t={r:"Engagement date",z:(cp?"":"End date")};
}else{
if(gpi=="r"){
var t={b:"Start date",z:(cp?"":"End date")};
}else{
if(gpi=="s"){
...
var fi=parent.EFI();
parent.EFC(fi,{"^":Spe,g:"m",l:p.q});
var mi=parent.EFI();
parent.EFC(mi,{"^":Spe,g:"f",s:fi,l:p.q});
...
SAP(f,p.m,p.f,"Set mother to ","setmother","Add new mother","addmother");
SAP(f,p.f,p.m,"Set father to ","setfather","Add new father","addfather");
SRB("Set no mother","setmother","");
SRB("Set no father","setfather","");
SRB("Cancel","cancel","");
}else{
...
var v=GE("treepartner");
v.options.length=0;
v.options[v.options.length]=new Option("","");
for(j=0;j<rn.length;j++){
v.options[v.options.length]=new Option(rn[j].n,rn[j].i);
}
SLR("relactions",1);
